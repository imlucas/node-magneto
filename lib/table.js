...
function Table(data){
    ...
    debug('set key schema', data.KeySchema, this.keySchema);
...
Table.prototype.getRawItem = function(keyData, attributesToGet){
    ...
    debug('getRawItem', 'key', key.toString(),  'result', item);
